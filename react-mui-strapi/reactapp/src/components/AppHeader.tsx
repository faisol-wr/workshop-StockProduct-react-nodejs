...
import { Logout, Money, Settings, Person, LanguageOutlined, NotificationsOutlined } from "@mui/icons-material"
    ...
    return (
        <AppBar position="sticky" sx={styles.appBar}>
            <Toolbar>
                ...
                >
                    <Avatar src="/assets/profile.webp" alt="Avatar" sx={{ width: 28, height: 28 }} />
                </IconButton>
                <Menu
                    id="menu"
                    anchorEl={anchorEl}
